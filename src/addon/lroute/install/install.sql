...
CREATE TABLE `pre__lroute` (
  ...
  `alias` char(250) DEFAULT NULL COMMENT '规则别名',
  `rule` text COMMENT '路由规则',
  `route` text COMMENT '路由地址',
  `method` varchar(50) DEFAULT NULL COMMENT '请求类型',
  `option` text COMMENT '路由参数',
  `pattern` text COMMENT '变量规则',
  `domain` text COMMENT '子域名',
  `template` text COMMENT '路由模板地址',
  `template_vars` text COMMENT '模版变量',
  `redirect_status` varchar(50) DEFAULT NULL COMMENT '跳转状态码',
  `append` text COMMENT '额外参数',
  `description` text COMMENT '规则描述',
  `sort` int(11) NOT NULL DEFAULT '100' COMMENT '排序',
  `status` tinyint(2) DEFAULT '1' COMMENT '状态',
  `edit_time` int(10) DEFAULT '0' COMMENT '编辑时间',
  `edit_ip` varchar(25) DEFAULT '' COMMENT '编辑IP',
